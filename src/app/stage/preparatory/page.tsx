          ...
          <div className="glass-card rounded-3xl p-10 shadow-2xl border-2 border-purple-300 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2 text-xs">
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full font-bold">📐 الرياضيات</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full font-bold">🔬 العلوم</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full font-bold">📖 اللغة العربية</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full font-bold">🌍 الدراسات</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full font-bold">🇬🇧 إنجليزي</span>
              </div>
